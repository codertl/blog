<template>
  <PageWrapper>
    <BasicForm @register="registerForm" @submit="handlerSearch" @reset="handlerReset" />
...
<script lang="ts" setup>
  ...
  import { schemas } from './config/formConfig';
  const data = [
    {
      title: '哈哈哈',
  ...
  const [registerForm] = useForm({
    schemas: schemas,
    labelWidth: 100,
    baseRowStyle: { backgroundColor: '#fff', marginBottom: '20px', paddingTop: '20px' },
  });
</script>
